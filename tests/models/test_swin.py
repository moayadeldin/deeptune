...
# Run the tests
test_swin_model_initialization()
test_swin_peft_model_initialization()
test_swin_model_regression_mode_initialization()
test_swin_peft_model_regression_mode_initialization()
