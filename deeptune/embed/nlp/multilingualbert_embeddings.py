...
from deeptune.utilities import load_finetunedbert_model
...
if USE_CASE == 'finetuned':
    ...
    OUTPUT = DEEPTUNE_RESULTS / f"test_set_finetuned_MultilingualBERT_embeddings.parquet"
    ...
    OUTPUT = DEEPTUNE_RESULTS / f"test_set_finetuned_MultilingualBERT_PEFT_embeddings.parquet"
    args.use_case = 'finetuned-MultiLingualBERT'
else:
