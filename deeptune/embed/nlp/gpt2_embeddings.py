...
from deeptune.utilities import load_finetuned_gpt2
from deeptune.src.nlp.gpt2 import download_gpt2_model, load_gpt2_model_offline, AdjustedGPT2Model
from deeptune.options import DEEPTUNE_RESULTS


parser = ArgumentParser(description="Extract Embeddings using GPT2 model")
OUTPUT = DEEPTUNE_RESULTS / f"test_set_pretrained_GPT2_embeddings.parquet"
