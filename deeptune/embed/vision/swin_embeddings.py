...
if USE_CASE == 'peft':
    ...
    TEST_OUTPUT = DEEPTUNE_RESULTS / f"test_set_peft_swin_embeddings_{MODE}.parquet"
    ...
    TEST_OUTPUT = DEEPTUNE_RESULTS / f"test_set_finetuned_swin_embeddings_{MODE}.parquet"
    ...
    TEST_OUTPUT = DEEPTUNE_RESULTS / f"test_set_pretrained_swin_embeddings_{MODE}.parquet"
