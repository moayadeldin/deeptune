...
if USE_CASE == 'finetuned':
    ...
    TEST_OUTPUT = DEEPTUNE_RESULTS / f"test_set_finetuned_DenseNet_embeddings_{MODE}.parquet"
    ...
    TEST_OUTPUT = DEEPTUNE_RESULTS / f"test_set_peft_DenseNet_embeddings_{MODE}.parquet"
