...
if USE_CASE == 'peft':
    ...
    TEST_OUTPUT = DEEPTUNE_RESULTS / f'test_set_peft_resnet_embeddings_{MODE}.parquet'
    ...
    TEST_OUTPUT = DEEPTUNE_RESULTS / f"test_set_finetuned_efficientnet_embeddings_{MODE}.parquet"
