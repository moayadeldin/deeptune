...
from deeptune.evaluators.vision.evaluate_siglip import evaluate_siglip
from deeptune.utils import get_model_cls, RunType
...
def main() -> None:
    ...
    EVAL_OUTPUT_DIR = DEEPTUNE_RESULTS / f"eval_output_{MODEL_STR}_{MODE}_{UNIQUE_ID}"
